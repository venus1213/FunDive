...
export const EmailABTestCreateArgsSchema: z.ZodType<Prisma.EmailABTestCreateArgs> = z.object({
  select: EmailABTestSelectSchema.optional(),
  include: z.lazy(() => EmailABTestIncludeSchema).optional(),
  data: z.union([ EmailABTestCreateInputSchema,EmailABTestUncheckedCreateInputSchema ]),
}).strict() ;

export default EmailABTestCreateArgsSchema;
