...
export const EmailABTestFindFirstOrThrowArgsSchema: z.ZodType<Prisma.EmailABTestFindFirstOrThrowArgs> = z.object({
...
export default EmailABTestFindFirstOrThrowArgsSchema;
