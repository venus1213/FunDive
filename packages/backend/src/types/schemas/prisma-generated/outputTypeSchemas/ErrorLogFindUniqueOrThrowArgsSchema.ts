...
export const ErrorLogFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ErrorLogFindUniqueOrThrowArgs> = z.object({
  select: ErrorLogSelectSchema.optional(),
  include: z.lazy(() => ErrorLogIncludeSchema).optional(),
  where: ErrorLogWhereUniqueInputSchema,
}).strict() ;

export default ErrorLogFindUniqueOrThrowArgsSchema;
