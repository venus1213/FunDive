...
import { EmailLogUpdateInputSchema } from '../inputTypeSchemas/EmailLogUpdateInputSchema'
import { EmailLogUncheckedUpdateInputSchema } from '../inputTypeSchemas/EmailLogUncheckedUpdateInputSchema'
...
export const EmailLogUpsertArgsSchema: z.ZodType<Prisma.EmailLogUpsertArgs> = z.object({
  select: EmailLogSelectSchema.optional(),
  include: z.lazy(() => EmailLogIncludeSchema).optional(),
  where: EmailLogWhereUniqueInputSchema,
  create: z.union([ EmailLogCreateInputSchema,EmailLogUncheckedCreateInputSchema ]),
  update: z.union([ EmailLogUpdateInputSchema,EmailLogUncheckedUpdateInputSchema ]),
}).strict() ;

export default EmailLogUpsertArgsSchema;
