...
export const EmailABTestResultFindManyArgsSchema: z.ZodType<Prisma.EmailABTestResultFindManyArgs> = z.object({
...
export default EmailABTestResultFindManyArgsSchema;
