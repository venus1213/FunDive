...
export const EmailLogUpdateArgsSchema: z.ZodType<Prisma.EmailLogUpdateArgs> = z.object({
  select: EmailLogSelectSchema.optional(),
  include: z.lazy(() => EmailLogIncludeSchema).optional(),
  data: z.union([ EmailLogUpdateInputSchema,EmailLogUncheckedUpdateInputSchema ]),
  where: EmailLogWhereUniqueInputSchema,
}).strict() ;

export default EmailLogUpdateArgsSchema;
