...
export const TransactionCreateNestedManyWithoutPaymentInputSchema: z.ZodType<Prisma.TransactionCreateNestedManyWithoutPaymentInput> = z.object({
...
export default TransactionCreateNestedManyWithoutPaymentInputSchema;
