...
export const EmailLogUpdateManyMutationInputSchema: z.ZodType<Prisma.EmailLogUpdateManyMutationInput> = z.object({
...
export default EmailLogUpdateManyMutationInputSchema;
