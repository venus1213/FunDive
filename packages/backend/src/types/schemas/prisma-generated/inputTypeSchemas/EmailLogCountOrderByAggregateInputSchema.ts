...
export const EmailLogCountOrderByAggregateInputSchema: z.ZodType<Prisma.EmailLogCountOrderByAggregateInput> = z.object({
...
export default EmailLogCountOrderByAggregateInputSchema;
