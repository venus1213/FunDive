...
import { MessageUpdateManyWithoutProjectNestedInputSchema } from './MessageUpdateManyWithoutProjectNestedInputSchema';
import { BookmarkUpdateManyWithoutProjectNestedInputSchema } from './BookmarkUpdateManyWithoutProjectNestedInputSchema';
...
export const ProjectUpdateWithoutReportsInputSchema: z.ZodType<Prisma.ProjectUpdateWithoutReportsInput> = z.object({
  ...
  messages: z.lazy(() => MessageUpdateManyWithoutProjectNestedInputSchema).optional(),
  bookmarks: z.lazy(() => BookmarkUpdateManyWithoutProjectNestedInputSchema).optional()
}).strict();

export default ProjectUpdateWithoutReportsInputSchema;
