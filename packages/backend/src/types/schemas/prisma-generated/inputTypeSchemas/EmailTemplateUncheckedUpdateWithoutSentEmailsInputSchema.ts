...
import { EmailABTestUncheckedUpdateManyWithoutTemplateNestedInputSchema } from './EmailABTestUncheckedUpdateManyWithoutTemplateNestedInputSchema';
...
export const EmailTemplateUncheckedUpdateWithoutSentEmailsInputSchema: z.ZodType<Prisma.EmailTemplateUncheckedUpdateWithoutSentEmailsInput> = z.object({
  ...
  abTests: z.lazy(() => EmailABTestUncheckedUpdateManyWithoutTemplateNestedInputSchema).optional(),
  schedules: z.lazy(() => EmailScheduleUncheckedUpdateManyWithoutTemplateNestedInputSchema).optional()
}).strict();

export default EmailTemplateUncheckedUpdateWithoutSentEmailsInputSchema;
