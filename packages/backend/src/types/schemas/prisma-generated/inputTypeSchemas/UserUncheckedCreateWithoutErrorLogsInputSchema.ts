...
export const UserUncheckedCreateWithoutErrorLogsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutErrorLogsInput> = z.object({
...
export default UserUncheckedCreateWithoutErrorLogsInputSchema;
