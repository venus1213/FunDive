...
import { EmailTemplateCreateNestedOneWithoutSchedulesInputSchema } from './EmailTemplateCreateNestedOneWithoutSchedulesInputSchema';

export const EmailScheduleCreateWithoutExecutionLogsInputSchema: z.ZodType<Prisma.EmailScheduleCreateWithoutExecutionLogsInput> = z.object({
  ...
  template: z.lazy(() => EmailTemplateCreateNestedOneWithoutSchedulesInputSchema)
}).strict();

export default EmailScheduleCreateWithoutExecutionLogsInputSchema;
