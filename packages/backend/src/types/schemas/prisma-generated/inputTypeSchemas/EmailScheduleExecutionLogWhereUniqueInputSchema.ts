...
import { EmailScheduleRelationFilterSchema } from './EmailScheduleRelationFilterSchema';
import { EmailScheduleWhereInputSchema } from './EmailScheduleWhereInputSchema';
import { EmailLogNullableRelationFilterSchema } from './EmailLogNullableRelationFilterSchema';
import { EmailLogWhereInputSchema } from './EmailLogWhereInputSchema';

export const EmailScheduleExecutionLogWhereUniqueInputSchema: z.ZodType<Prisma.EmailScheduleExecutionLogWhereUniqueInput> = z.object({
  id: z.string()
})
.and(z.object({
  ...
  schedule: z.union([ z.lazy(() => EmailScheduleRelationFilterSchema),z.lazy(() => EmailScheduleWhereInputSchema) ]).optional(),
  emailLog: z.union([ z.lazy(() => EmailLogNullableRelationFilterSchema),z.lazy(() => EmailLogWhereInputSchema) ]).optional().nullable(),
}).strict());

export default EmailScheduleExecutionLogWhereUniqueInputSchema;
