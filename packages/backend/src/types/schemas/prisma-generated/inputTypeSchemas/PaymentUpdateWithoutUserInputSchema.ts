...
import { TransactionUpdateManyWithoutPaymentNestedInputSchema } from './TransactionUpdateManyWithoutPaymentNestedInputSchema';
...
export const PaymentUpdateWithoutUserInputSchema: z.ZodType<Prisma.PaymentUpdateWithoutUserInput> = z.object({
  ...
  transactions: z.lazy(() => TransactionUpdateManyWithoutPaymentNestedInputSchema).optional()
}).strict();

export default PaymentUpdateWithoutUserInputSchema;
