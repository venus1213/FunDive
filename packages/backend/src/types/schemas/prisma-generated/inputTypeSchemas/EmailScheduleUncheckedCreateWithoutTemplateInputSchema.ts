...
import { EmailScheduleExecutionLogUncheckedCreateNestedManyWithoutScheduleInputSchema } from './EmailScheduleExecutionLogUncheckedCreateNestedManyWithoutScheduleInputSchema';

export const EmailScheduleUncheckedCreateWithoutTemplateInputSchema: z.ZodType<Prisma.EmailScheduleUncheckedCreateWithoutTemplateInput> = z.object({
  ...
  executionLogs: z.lazy(() => EmailScheduleExecutionLogUncheckedCreateNestedManyWithoutScheduleInputSchema).optional()
}).strict();

export default EmailScheduleUncheckedCreateWithoutTemplateInputSchema;
