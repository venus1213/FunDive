...
import { UserUpdateOneWithoutActivityLogsNestedInputSchema } from './UserUpdateOneWithoutActivityLogsNestedInputSchema';
...
export const ActivityLogUpdateInputSchema: z.ZodType<Prisma.ActivityLogUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneWithoutActivityLogsNestedInputSchema).optional()
}).strict();

export default ActivityLogUpdateInputSchema;
