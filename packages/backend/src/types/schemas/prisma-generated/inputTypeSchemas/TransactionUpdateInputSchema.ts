...
import { PaymentUpdateOneRequiredWithoutTransactionsNestedInputSchema } from './PaymentUpdateOneRequiredWithoutTransactionsNestedInputSchema';
...
export const TransactionUpdateInputSchema: z.ZodType<Prisma.TransactionUpdateInput> = z.object({
  ...
  payment: z.lazy(() => PaymentUpdateOneRequiredWithoutTransactionsNestedInputSchema).optional()
}).strict();
