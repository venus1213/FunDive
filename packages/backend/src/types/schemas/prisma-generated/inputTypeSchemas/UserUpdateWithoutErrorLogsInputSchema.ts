...
export const UserUpdateWithoutErrorLogsInputSchema: z.ZodType<Prisma.UserUpdateWithoutErrorLogsInput> = z.object({
...
export default UserUpdateWithoutErrorLogsInputSchema;
