...
export const EmailLogUncheckedUpdateInputSchema: z.ZodType<Prisma.EmailLogUncheckedUpdateInput> = z.object({
...
export default EmailLogUncheckedUpdateInputSchema;
