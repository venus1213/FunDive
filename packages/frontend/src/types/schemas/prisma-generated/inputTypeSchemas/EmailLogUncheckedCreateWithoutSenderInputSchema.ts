...
export const EmailLogUncheckedCreateWithoutSenderInputSchema: z.ZodType<Prisma.EmailLogUncheckedCreateWithoutSenderInput> = z.object({
...
export default EmailLogUncheckedCreateWithoutSenderInputSchema;
