...
export const EmailScheduleCountOrderByAggregateInputSchema: z.ZodType<Prisma.EmailScheduleCountOrderByAggregateInput> = z.object({
...
export default EmailScheduleCountOrderByAggregateInputSchema;
