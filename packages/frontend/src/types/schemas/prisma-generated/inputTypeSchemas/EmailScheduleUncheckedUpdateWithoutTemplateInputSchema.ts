...
import { EmailScheduleExecutionLogUncheckedUpdateManyWithoutScheduleNestedInputSchema } from './EmailScheduleExecutionLogUncheckedUpdateManyWithoutScheduleNestedInputSchema';

export const EmailScheduleUncheckedUpdateWithoutTemplateInputSchema: z.ZodType<Prisma.EmailScheduleUncheckedUpdateWithoutTemplateInput> = z.object({
  ...
  executionLogs: z.lazy(() => EmailScheduleExecutionLogUncheckedUpdateManyWithoutScheduleNestedInputSchema).optional()
}).strict();

export default EmailScheduleUncheckedUpdateWithoutTemplateInputSchema;
