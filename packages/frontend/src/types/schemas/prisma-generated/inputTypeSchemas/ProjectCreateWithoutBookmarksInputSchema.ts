...
export const ProjectCreateWithoutBookmarksInputSchema: z.ZodType<Prisma.ProjectCreateWithoutBookmarksInput> = z.object({
...
export default ProjectCreateWithoutBookmarksInputSchema;
