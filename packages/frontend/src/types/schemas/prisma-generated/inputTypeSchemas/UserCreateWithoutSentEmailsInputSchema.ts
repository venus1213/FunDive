...
export const UserCreateWithoutSentEmailsInputSchema: z.ZodType<Prisma.UserCreateWithoutSentEmailsInput> = z.object({
...
export default UserCreateWithoutSentEmailsInputSchema;
