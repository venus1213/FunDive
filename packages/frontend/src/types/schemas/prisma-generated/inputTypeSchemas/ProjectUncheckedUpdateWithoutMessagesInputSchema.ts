...
import { BookmarkUncheckedUpdateManyWithoutProjectNestedInputSchema } from './BookmarkUncheckedUpdateManyWithoutProjectNestedInputSchema';
...
export const ProjectUncheckedUpdateWithoutMessagesInputSchema: z.ZodType<Prisma.ProjectUncheckedUpdateWithoutMessagesInput> = z.object({
  ...
  bookmarks: z.lazy(() => BookmarkUncheckedUpdateManyWithoutProjectNestedInputSchema).optional(),
  reports: z.lazy(() => ReportUncheckedUpdateManyWithoutProjectNestedInputSchema).optional()
}).strict();

export default ProjectUncheckedUpdateWithoutMessagesInputSchema;
