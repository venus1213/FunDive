...
export const EmailTemplateCreateNestedManyWithoutUpdaterInputSchema: z.ZodType<Prisma.EmailTemplateCreateNestedManyWithoutUpdaterInput> = z.object({
...
export default EmailTemplateCreateNestedManyWithoutUpdaterInputSchema;
