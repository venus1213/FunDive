...
export const MessageCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.MessageCreateNestedManyWithoutProjectInput> = z.object({
...
export default MessageCreateNestedManyWithoutProjectInputSchema;
