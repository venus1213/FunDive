...
export const EmailLogMaxOrderByAggregateInputSchema: z.ZodType<Prisma.EmailLogMaxOrderByAggregateInput> = z.object({
...
export default EmailLogMaxOrderByAggregateInputSchema;
