...
import { ProjectUpdateOneWithoutReportsNestedInputSchema } from './ProjectUpdateOneWithoutReportsNestedInputSchema';
...
export const ReportUpdateWithoutReporterInputSchema: z.ZodType<Prisma.ReportUpdateWithoutReporterInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneWithoutReportsNestedInputSchema).optional()
}).strict();

export default ReportUpdateWithoutReporterInputSchema;
