...
export const UserUpdateWithoutSentEmailsInputSchema: z.ZodType<Prisma.UserUpdateWithoutSentEmailsInput> = z.object({
...
export default UserUpdateWithoutSentEmailsInputSchema;
