...
export const TransactionUncheckedCreateWithoutPaymentInputSchema: z.ZodType<Prisma.TransactionUncheckedCreateWithoutPaymentInput> = z.object({
...
export default TransactionUncheckedCreateWithoutPaymentInputSchema;
