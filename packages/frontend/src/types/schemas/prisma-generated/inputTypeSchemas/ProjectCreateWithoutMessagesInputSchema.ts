...
export const ProjectCreateWithoutMessagesInputSchema: z.ZodType<Prisma.ProjectCreateWithoutMessagesInput> = z.object({
...
export default ProjectCreateWithoutMessagesInputSchema;
