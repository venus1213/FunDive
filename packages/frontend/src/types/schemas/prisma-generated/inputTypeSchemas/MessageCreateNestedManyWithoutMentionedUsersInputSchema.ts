...
export const MessageCreateNestedManyWithoutMentionedUsersInputSchema: z.ZodType<Prisma.MessageCreateNestedManyWithoutMentionedUsersInput> = z.object({
...
export default MessageCreateNestedManyWithoutMentionedUsersInputSchema;
