...
export const UserUncheckedCreateWithoutSentEmailsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutSentEmailsInput> = z.object({
...
export default UserUncheckedCreateWithoutSentEmailsInputSchema;
