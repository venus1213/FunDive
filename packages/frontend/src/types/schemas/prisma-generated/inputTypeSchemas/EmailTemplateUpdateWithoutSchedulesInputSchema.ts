...
import { EmailLogUpdateManyWithoutTemplateNestedInputSchema } from './EmailLogUpdateManyWithoutTemplateNestedInputSchema';
import { EmailABTestUpdateManyWithoutTemplateNestedInputSchema } from './EmailABTestUpdateManyWithoutTemplateNestedInputSchema';

export const EmailTemplateUpdateWithoutSchedulesInputSchema: z.ZodType<Prisma.EmailTemplateUpdateWithoutSchedulesInput> = z.object({
  ...
  sentEmails: z.lazy(() => EmailLogUpdateManyWithoutTemplateNestedInputSchema).optional(),
  abTests: z.lazy(() => EmailABTestUpdateManyWithoutTemplateNestedInputSchema).optional()
}).strict();

export default EmailTemplateUpdateWithoutSchedulesInputSchema;
