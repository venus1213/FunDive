...
export const EmailScheduleCreateManyInputSchema: z.ZodType<Prisma.EmailScheduleCreateManyInput> = z.object({
...
export default EmailScheduleCreateManyInputSchema;
