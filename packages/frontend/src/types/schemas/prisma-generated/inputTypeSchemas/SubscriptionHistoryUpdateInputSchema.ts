...
import { UserUpdateOneRequiredWithoutSubscriptionHistoryNestedInputSchema } from './UserUpdateOneRequiredWithoutSubscriptionHistoryNestedInputSchema';

export const SubscriptionHistoryUpdateInputSchema: z.ZodType<Prisma.SubscriptionHistoryUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutSubscriptionHistoryNestedInputSchema).optional()
}).strict();

export default SubscriptionHistoryUpdateInputSchema;
