...
export const EmailLogUpdateManyWithoutSenderNestedInputSchema: z.ZodType<Prisma.EmailLogUpdateManyWithoutSenderNestedInput> = z.object({
...
export default EmailLogUpdateManyWithoutSenderNestedInputSchema;
