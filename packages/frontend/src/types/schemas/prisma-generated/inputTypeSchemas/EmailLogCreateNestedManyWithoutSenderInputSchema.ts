...
export const EmailLogCreateNestedManyWithoutSenderInputSchema: z.ZodType<Prisma.EmailLogCreateNestedManyWithoutSenderInput> = z.object({
...
export default EmailLogCreateNestedManyWithoutSenderInputSchema;
