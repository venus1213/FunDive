...
export const EmailABTestResultFindFirstArgsSchema: z.ZodType<Prisma.EmailABTestResultFindFirstArgs> = z.object({
...
export default EmailABTestResultFindFirstArgsSchema;
