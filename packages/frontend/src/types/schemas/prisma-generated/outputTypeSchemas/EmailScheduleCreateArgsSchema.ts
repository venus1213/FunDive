...
export const EmailScheduleCreateArgsSchema: z.ZodType<Prisma.EmailScheduleCreateArgs> = z.object({
  select: EmailScheduleSelectSchema.optional(),
  include: z.lazy(() => EmailScheduleIncludeSchema).optional(),
  data: z.union([ EmailScheduleCreateInputSchema,EmailScheduleUncheckedCreateInputSchema ]),
}).strict() ;

export default EmailScheduleCreateArgsSchema;
