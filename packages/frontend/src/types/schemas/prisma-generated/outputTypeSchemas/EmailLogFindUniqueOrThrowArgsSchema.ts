...
export const EmailLogFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EmailLogFindUniqueOrThrowArgs> = z.object({
  select: EmailLogSelectSchema.optional(),
  include: z.lazy(() => EmailLogIncludeSchema).optional(),
  where: EmailLogWhereUniqueInputSchema,
}).strict() ;

export default EmailLogFindUniqueOrThrowArgsSchema;
