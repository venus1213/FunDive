...
export const EmailABTestUpdateArgsSchema: z.ZodType<Prisma.EmailABTestUpdateArgs> = z.object({
  select: EmailABTestSelectSchema.optional(),
  include: z.lazy(() => EmailABTestIncludeSchema).optional(),
  data: z.union([ EmailABTestUpdateInputSchema,EmailABTestUncheckedUpdateInputSchema ]),
  where: EmailABTestWhereUniqueInputSchema,
}).strict() ;

export default EmailABTestUpdateArgsSchema;
