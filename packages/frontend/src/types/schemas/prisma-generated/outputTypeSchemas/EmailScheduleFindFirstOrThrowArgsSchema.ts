...
export const EmailScheduleFindFirstOrThrowArgsSchema: z.ZodType<Prisma.EmailScheduleFindFirstOrThrowArgs> = z.object({
...
export default EmailScheduleFindFirstOrThrowArgsSchema;
