...
export default function EditEmailTemplatePage() {
  ...
  const form = useForm<TemplateForm>({
    ...
    defaultValues: {
      ...
      body: template?.body || "",
      type: (template?.type as "NOTIFICATION" | "MARKETING" | "ANNOUNCEMENT" | "REMINDER" | "CUSTOM") || "CUSTOM",
    ...
    values: template ? {
      ...
      subject: template.subject,
      body: template.body,
      type: template.type as "NOTIFICATION" | "MARKETING" | "ANNOUNCEMENT" | "REMINDER" | "CUSTOM",
      variables: template.variables || {},
      isActive: template.isActive,
    } : undefined,
  });
  ...
  const updateMutation = useMutation({
    mutationFn: (data: TemplateForm) => adminApi.updateEmailTemplate(templateId, data),
    onSuccess: () => {
      toast({
        title: "更新完了",
